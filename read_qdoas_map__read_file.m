function [ outarr ] = read_qdoas_map__read_file( fname, header)
...
formatSpec=[repmat('%s',1,length(header)-1) '%[^\n\r]'];

fid = fopen(fname,'r');

dataArray = textscan(fid, formatSpec, 'Delimiter', '\t', 'HeaderLines' ,2, 'ReturnOnError', false);
