...
frac_myi=bee_dataset.MYSI_3day./(bee_dataset.FYSI_3day+bee_dataset.MYSI_3day);
...
sizes=bee_dataset.MYSI_3day(ind_tmp)/max(bee_dataset.MYSI_3day(ind_tmp));
sizes=(sizes*100)+5;

scatter3(bee_dataset.mixing_height_3day(ind_tmp),...
         bee_dataset.frac_in_mix_3day(ind_tmp),...
