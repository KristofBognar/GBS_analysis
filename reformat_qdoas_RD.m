...
function data=import_p(filename)
    %% Initialize variables.
    delimiter = '\t';
    startRow = 3;
    endRow = inf;
    ...
    data.Timehhmmss = dates{:, 2};
    data.TotalExperimentTimesec = cell2mat(rawNumericColumns(:, 11));
    data.O3RMS = cell2mat(rawNumericColumns(:, 12));
    data.O3RefZm = cell2mat(rawNumericColumns(:, 13));
    data.O3processing_error = cell2mat(rawNumericColumns(:, 14));
    data.O3SlColRing = cell2mat(rawNumericColumns(:, 15));
    data.O3SlErrRing = cell2mat(rawNumericColumns(:, 16));
    data.O3SlColno2 = cell2mat(rawNumericColumns(:, 17));
    data.O3SlErrno2 = cell2mat(rawNumericColumns(:, 18));
    data.O3SlColo3 = cell2mat(rawNumericColumns(:, 19));
    data.O3SlErro3 = cell2mat(rawNumericColumns(:, 20));
    data.O3SlColo3a = cell2mat(rawNumericColumns(:, 21));
    data.O3SlErro3a = cell2mat(rawNumericColumns(:, 22));
    data.O3SlColo3p1 = cell2mat(rawNumericColumns(:, 23));
    data.O3SlErro3p1 = cell2mat(rawNumericColumns(:, 24));
    data.O3SlColo3p2 = cell2mat(rawNumericColumns(:, 25));
    data.O3SlErro3p2 = cell2mat(rawNumericColumns(:, 26));
    data.O3SlColhcho = cell2mat(rawNumericColumns(:, 27));
    data.O3SlErrhcho = cell2mat(rawNumericColumns(:, 28));
    data.O3SlColx0 = cell2mat(rawNumericColumns(:, 29));
    data.O3SlErrx0 = cell2mat(rawNumericColumns(:, 30));
    data.O3SlColx1 = cell2mat(rawNumericColumns(:, 31));
    data.O3SlErrx1 = cell2mat(rawNumericColumns(:, 32));
    data.O3SlColx2 = cell2mat(rawNumericColumns(:, 33));
    data.O3SlErrx2 = cell2mat(rawNumericColumns(:, 34));
    data.O3SlColx3 = cell2mat(rawNumericColumns(:, 35));
    data.O3SlErrx3 = cell2mat(rawNumericColumns(:, 36));
    data.O3ShiftSpectrum = cell2mat(rawNumericColumns(:, 37));
    data.O3StretchSpectrum1 = cell2mat(rawNumericColumns(:, 38));
    data.O3StretchSpectrum2 = cell2mat(rawNumericColumns(:, 39));
    data.NO2RMS = cell2mat(rawNumericColumns(:, 40));
    data.NO2RefZm = cell2mat(rawNumericColumns(:, 41));
    data.NO2processing_error = cell2mat(rawNumericColumns(:, 42));
    data.NO2SlColo4 = cell2mat(rawNumericColumns(:, 43));
    data.NO2SlErro4 = cell2mat(rawNumericColumns(:, 44));
    data.NO2SlColRing = cell2mat(rawNumericColumns(:, 45));
    data.NO2SlErrRing = cell2mat(rawNumericColumns(:, 46));
    data.NO2SlColno2 = cell2mat(rawNumericColumns(:, 47));
    data.NO2SlErrno2 = cell2mat(rawNumericColumns(:, 48));
    data.NO2SlColo3 = cell2mat(rawNumericColumns(:, 49));
    data.NO2SlErro3 = cell2mat(rawNumericColumns(:, 50));
    data.NO2SlColoclo = cell2mat(rawNumericColumns(:, 51));
    data.NO2SlErroclo = cell2mat(rawNumericColumns(:, 52));
    data.NO2SlColbro = cell2mat(rawNumericColumns(:, 53));
    data.NO2SlErrbro = cell2mat(rawNumericColumns(:, 54));
    data.NO2ShiftSpectrum = cell2mat(rawNumericColumns(:, 55));
    data.NO2StretchSpectrum1 = cell2mat(rawNumericColumns(:, 56));
    data.NO2StretchSpectrum2 = cell2mat(rawNumericColumns(:, 57));
    data.Fluxes355 = cell2mat(rawNumericColumns(:, 58));
    data.Fluxes360 = cell2mat(rawNumericColumns(:, 59));
    data.Fluxes380 = cell2mat(rawNumericColumns(:, 60));
    data.Fluxes385 = cell2mat(rawNumericColumns(:, 61));
    data.Fluxes390 = cell2mat(rawNumericColumns(:, 62));
    data.Fluxes405 = cell2mat(rawNumericColumns(:, 63));
    data.Fluxes420 = cell2mat(rawNumericColumns(:, 64));
    data.Fluxes425 = cell2mat(rawNumericColumns(:, 65));
    data.Fluxes435 = cell2mat(rawNumericColumns(:, 66));
    data.Fluxes440 = cell2mat(rawNumericColumns(:, 67));
    data.Fluxes445 = cell2mat(rawNumericColumns(:, 68));
    data.Fluxes450 = cell2mat(rawNumericColumns(:, 69));
    data.Fluxes455 = cell2mat(rawNumericColumns(:, 70));
    data.Fluxes460 = cell2mat(rawNumericColumns(:, 71));
    data.Fluxes470 = cell2mat(rawNumericColumns(:, 72));
    data.Fluxes490 = cell2mat(rawNumericColumns(:, 73));
    data.Fluxes500 = cell2mat(rawNumericColumns(:, 74));
    data.Fluxes532 = cell2mat(rawNumericColumns(:, 75));
